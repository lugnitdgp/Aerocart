  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      ...
      Padding(
          ...
          child: MyButton(ontap: (){}, text: "Checkout- ₹${(widget.cost + shipping).toString()}"), 
          ),        
      appBar: AppBar(
        elevation: 3,
        title: const Center(
            ...
            child: Column(
              children: [
                ...
                Padding(
                  ...
                  child: Row(
                    children: [
                      const Text("Deliver to- ",style: TextStyle(fontSize: 18,fontWeight: FontWeight.w400),),
                      Text(userDetailsModel.address,style: const TextStyle(fontSize: 17,fontWeight: FontWeight.w400),),
                    ],
                  ),
                )
              ],
